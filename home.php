...
<body>
    ...
    <?php if (isset($_SESSION['message'])): ?>
        <div class="alert-box <?php echo $_SESSION['status']; ?>" id="alertBox">
    ...
    <header>
        <h1 class="text">SELAMAT DATANG DI PERPUSTAKAAN ITH</h1>
    </header>
    ...
    <script>
        // Fungsi untuk menutup message box secara otomatis setelah 3 detik
        window.onload = function() {
            const alertBox = document.getElementById('alertBox');

            if (alertBox) {
                // Tutup alert box setelah 3 detik
                setTimeout(function() {
